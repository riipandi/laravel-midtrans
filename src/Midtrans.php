...
use Riipandi\Midtrans\Notification;
...
class Midtrans {
    ...
    public static function registerMidtransConfig() {
        ...
        Config::$curlOptions = config('services.midtrans.curl_options');
        $configEnv = config('services.midtrans.env');
